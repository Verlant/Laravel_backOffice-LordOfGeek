    ...
    <div class="max-w-7xl w-10/12 mx-auto mt-6 py-6 px-4 sm:px-6 lg:px-8 bg-white dark:bg-gray-800 rounded shadow">
        <form action="{{route('categories.store')}}" method="post">
            ...
            <div class="flex flex-col">
                <label for="nouveau-libelle-categorie" class="text-gray-800 dark:text-gray-300 mb-1 font-bold">{{__('Wording')}}</label>
                <input type="text" name="nouveau-libelle-categorie" id="nouveau-libelle-categorie" placeholder="Libellé de la nouvelle catégorie" class="rounded border-gray-200 dark:border-gray-400">
                @error("nouveau-libelle-categorie")
